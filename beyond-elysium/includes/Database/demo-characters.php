...
return [
	...
	[
		...
		'sheet_data'  => [
			...
			'vampire-abilities'   => [ [ 'name' => 'Occult', 'count' => 4 ], [ 'name' => 'Academics', 'count' => 3 ], [ 'name' => 'Investigation', 'count' => 2 ], [ 'name' => 'Etiquette', 'count' => 2 ] ],
			'vampire-merits'      => [ [ 'name' => 'Iron Will', 'count' => 5 ] ],
			'vampire-flaws'       => [ [ 'name' => 'Curiosity', 'count' => 2 ] ],
			'vampire-backgrounds' => [ [ 'name' => 'Resources', 'count' => 2 ], [ 'name' => 'Retainers', 'count' => 1 ] ],
			'vampire-disciplines' => [ [ 'name' => 'Auspex', 'level' => 1 ] ],
			'vampire-blood-magic' => [ [ 'name' => 'Path of Blood', 'level' => 2, 'tradition' => 'Thaumaturgy (Camarilla)' ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'vampire-abilities'   => [ [ 'name' => 'Streetwise', 'count' => 4 ], [ 'name' => 'Stealth', 'count' => 3 ], [ 'name' => 'Awareness', 'count' => 3 ], [ 'name' => 'Brawl', 'count' => 2 ] ],
			'vampire-merits'      => [ [ 'name' => 'Danger Sense', 'count' => 2 ] ],
			'vampire-flaws'       => [ [ 'name' => 'Dark Secret' ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'werewolf-abilities'   => [ [ 'name' => 'Leadership', 'count' => 3 ], [ 'name' => 'Politics', 'count' => 2 ], [ 'name' => 'Occult', 'count' => 1 ], [ 'name' => 'Brawl', 'count' => 2 ] ],
			'werewolf-merits'      => [ [ 'name' => 'Natural Leader' ] ],
			'werewolf-flaws'       => [ [ 'name' => 'Overconfident', 'count' => 1 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'werewolf-abilities'   => [ [ 'name' => 'Survival', 'count' => 4 ], [ 'name' => 'Expression', 'count' => 3 ], [ 'name' => 'Awareness', 'count' => 2 ], [ 'name' => 'Athletics', 'count' => 2 ] ],
			'werewolf-merits'      => [ [ 'name' => 'Common Sense' ] ],
			'werewolf-flaws'       => [ [ 'name' => 'Territorial', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'mage-abilities'      => [ [ 'name' => 'Occult', 'count' => 4 ], [ 'name' => 'Academics', 'count' => 3 ], [ 'name' => 'Science', 'count' => 2 ], [ 'name' => 'Investigation', 'count' => 2 ] ],
			'mage-merits'         => [ [ 'name' => 'Eidetic Memory', 'count' => 5 ] ],
			'mage-flaws'          => [ [ 'name' => 'Absent-Minded', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'mage-abilities'      => [ [ 'name' => 'Medicine', 'count' => 3 ], [ 'name' => 'Occult', 'count' => 3 ], [ 'name' => 'Empathy', 'count' => 2 ], [ 'name' => 'Survival', 'count' => 2 ] ],
			'mage-merits'         => [ [ 'name' => 'Higher Purpose' ] ],
			'mage-flaws'          => [ [ 'name' => 'Nightmares', 'count' => 4 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'changeling-abilities'   => [ [ 'name' => 'Performance', 'count' => 3 ], [ 'name' => 'Subterfuge', 'count' => 2 ], [ 'name' => 'Streetwise', 'count' => 2 ] ],
			'changeling-merits'      => [ [ 'name' => 'Daredevil', 'count' => 3 ] ],
			'changeling-flaws'       => [ [ 'name' => 'Curiosity', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'changeling-abilities'   => [ [ 'name' => 'Etiquette', 'count' => 3 ], [ 'name' => 'Occult', 'count' => 2 ], [ 'name' => 'Subterfuge', 'count' => 2 ] ],
			'changeling-merits'      => [ [ 'name' => 'Enchanting Voice', 'count' => 2 ] ],
			'changeling-flaws'       => [ [ 'name' => 'Compulsion', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'demon-abilities'     => [ [ 'name' => 'Occult', 'count' => 3 ], [ 'name' => 'Intimidation', 'count' => 3 ], [ 'name' => 'Politics', 'count' => 2 ], [ 'name' => 'Lore', 'specialization' => 'Vampire', 'count' => 1 ], [ 'name' => 'Lore', 'specialization' => 'Werewolf', 'count' => 1 ] ],
			'demon-merits'        => [ [ 'name' => 'Celestial Attunement' ] ],
			'demon-flaws'         => [ [ 'name' => 'Dark Fate', 'count' => 5 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'demon-abilities'     => [ [ 'name' => 'Melee', 'count' => 3 ], [ 'name' => 'Intimidation', 'count' => 2 ], [ 'name' => 'Occult', 'count' => 2 ], [ 'name' => 'Lore', 'specialization' => 'Mage', 'count' => 1 ], [ 'name' => 'Lore', 'specialization' => 'Spirit', 'count' => 1 ] ],
			'demon-merits'        => [ [ 'name' => 'Luck', 'count' => 3 ] ],
			'demon-flaws'         => [ [ 'name' => 'Hatred', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'fera-abilities'      => [ [ 'name' => 'Medicine', 'count' => 3 ], [ 'name' => 'Survival', 'count' => 3 ], [ 'name' => 'Brawl', 'count' => 2 ] ],
			'fera-merits'         => [ [ 'name' => 'Guardian Angel', 'count' => 6 ] ],
			'fera-flaws'          => [ [ 'name' => 'Deep Sleeper' ] ],
			...
			'fera-rites'          => [ [ 'name' => 'Rite of Contrition' ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'fera-identity'       => [ 'Fera Type' => 'Kitsune', 'Breed' => 'Roko', 'Rank' => 1, 'Totem' => 'Fox' ],
			'met-physical-traits' => [ [ 'name' => 'Agile', 'count' => 2 ] ],
			'met-social-traits'   => [ [ 'name' => 'Beguiling', 'count' => 3 ] ],
			'met-mental-traits'   => [ [ 'name' => 'Insightful', 'count' => 3 ] ],
			'fera-abilities'      => [ [ 'name' => 'Subterfuge', 'count' => 3 ], [ 'name' => 'Occult', 'count' => 3 ], [ 'name' => 'Stealth', 'count' => 2 ] ],
			'fera-merits'         => [ [ 'name' => 'Oracular Ability', 'count' => 3 ] ],
			'fera-flaws'          => [ [ 'name' => 'Dangerous Secret' ] ],
			'fera-backgrounds'    => [ [ 'name' => 'Mnesis', 'count' => 2 ], [ 'name' => 'Secrets', 'count' => 1 ] ],
			// Sense Wyrm is a Kitsune: Shinju pick, Falling Touch a Kitsune: Eji pick, both basic rank (fera-gifts.json).
			'fera-gifts'          => [ [ 'name' => 'Kitsune: Shinju', 'power_name' => 'Sense Wyrm' ], [ 'name' => 'Kitsune: Eji', 'power_name' => 'Falling Touch' ] ],
			'fera-rites'          => [ [ 'name' => 'Rite of Talisman Dedication' ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'fera-abilities'      => [ [ 'name' => 'Stealth', 'count' => 3 ], [ 'name' => 'Crafts', 'count' => 2 ], [ 'name' => 'Occult', 'count' => 2 ] ],
			'fera-merits'         => [ [ 'name' => 'Danger Sense', 'count' => 2 ] ],
			'fera-flaws'          => [ [ 'name' => 'Phobia', 'count' => 3 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'fera-abilities'      => [ [ 'name' => 'Scrounge', 'count' => 3 ], [ 'name' => 'Crafts', 'count' => 2 ], [ 'name' => 'Brawl', 'count' => 2 ] ],
			'fera-merits'         => [ [ 'name' => 'Ambidextrous' ] ],
			'fera-flaws'          => [ [ 'name' => 'Short', 'count' => 1 ] ],
			'fera-backgrounds'    => [ [ 'name' => 'Colony', 'count' => 2 ], [ 'name' => 'Go-en', 'count' => 1 ] ],
			// Razor Claws is a Bastet: Khan pick, basic rank (fera-gifts.json).
	...
	[
		...
		'sheet_data'  => [
			...
			'kueijin-identity'    => [ 'Dharma' => 'Way of the Resplendent Crane', 'Direction' => 'East', 'Balance' => 'Balanced', 'Station' => 'Wu Xing Envoy' ],
			'met-physical-traits' => [ [ 'name' => 'Graceful', 'count' => 2 ] ],
			'met-social-traits'   => [ [ 'name' => 'Diplomatic', 'count' => 3 ] ],
			'met-mental-traits'   => [ [ 'name' => 'Wise', 'count' => 3 ] ],
			'kueijin-abilities'   => [ [ 'name' => 'Etiquette', 'count' => 3 ], [ 'name' => 'Occult', 'count' => 3 ], [ 'name' => 'Meditation', 'count' => 2 ] ],
			'kueijin-merits'      => [ [ 'name' => 'Sanctity', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'kueijin-identity'    => [ 'Dharma' => 'Howl of the Devil-Tiger', 'Direction' => 'West', 'Balance' => 'Wrathful', 'Station' => 'Enforcer' ],
			'met-physical-traits' => [ [ 'name' => 'Ferocious', 'count' => 3 ] ],
			'met-social-traits'   => [ [ 'name' => 'Intimidating', 'count' => 2 ] ],
			'met-mental-traits'   => [ [ 'name' => 'Determined', 'count' => 3 ] ],
			'kueijin-abilities'   => [ [ 'name' => 'Melee', 'count' => 3 ], [ 'name' => 'Intimidation', 'count' => 2 ], [ 'name' => 'Brawl', 'count' => 2 ] ],
			'kueijin-merits'      => [ [ 'name' => 'Iron Will', 'count' => 5 ] ],
			'kueijin-flaws'       => [ [ 'name' => 'Vengeance', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'mortal-abilities'    => [ [ 'name' => 'Investigation', 'count' => 4 ], [ 'name' => 'Firearms', 'count' => 3 ], [ 'name' => 'Streetwise', 'count' => 2 ], [ 'name' => 'Empathy', 'count' => 2 ] ],
			'mortal-merits'       => [ [ 'name' => 'Common Sense' ] ],
			'mortal-flaws'        => [ [ 'name' => 'Insomnia', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'mortal-abilities'    => [ [ 'name' => 'Brawl', 'count' => 3 ], [ 'name' => 'Intimidation', 'count' => 2 ], [ 'name' => 'Occult', 'count' => 1 ] ],
			'mortal-merits'       => [ [ 'name' => 'Concentration' ] ],
			'mortal-flaws'        => [ [ 'name' => 'Addiction', 'count' => 2 ] ],
			'mortal-backgrounds'  => [ [ 'name' => 'Backers', 'count' => 1 ], [ 'name' => 'Equipment', 'count' => 1 ] ],
			'mortal-fomori'       => [ [ 'name' => 'Berserker' ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'mummy-abilities'     => [ [ 'name' => 'Occult', 'count' => 4 ], [ 'name' => 'Academics', 'count' => 3 ], [ 'name' => 'Medicine', 'count' => 2 ] ],
			'mummy-merits'        => [ [ 'name' => 'Destiny', 'count' => 4 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'mummy-abilities'     => [ [ 'name' => 'Medicine', 'count' => 3 ], [ 'name' => 'Occult', 'count' => 3 ], [ 'name' => 'Leadership', 'count' => 2 ] ],
			'mummy-merits'        => [ [ 'name' => 'Higher Purpose' ] ],
			'mummy-flaws'         => [ [ 'name' => 'Driving Goal', 'count' => 3 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'wraith-abilities'    => [ [ 'name' => 'Subterfuge', 'count' => 3 ], [ 'name' => 'Stealth', 'count' => 2 ], [ 'name' => 'Occult', 'count' => 2 ] ],
			'wraith-merits'       => [ [ 'name' => 'Medium', 'count' => 2 ] ],
			'wraith-flaws'        => [ [ 'name' => 'Haunted', 'count' => 2 ] ],
	...
	[
		...
		'sheet_data'  => [
			...
			'wraith-abilities'    => [ [ 'name' => 'Academics', 'count' => 3 ], [ 'name' => 'Expression', 'count' => 2 ], [ 'name' => 'Empathy', 'count' => 2 ] ],
			'wraith-merits'       => [ [ 'name' => 'Eidetic Memory', 'count' => 5 ] ],
			'wraith-flaws'        => [ [ 'name' => 'Low Self-Image', 'count' => 2 ] ],
