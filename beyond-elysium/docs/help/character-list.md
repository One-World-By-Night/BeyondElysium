...
A searchable, sortable list of characters, with a link to each one's sheet.
...
- **Assign a player** (Storyteller-only modal) - search by at least three letters of a name,
  ...
  unassign the current player, or record a pending email for someone who hasn't registered
  an account yet.
...
1. Open **My Chronicle** → **Characters**.
2. Click its name to open the Sheet.

### Filter or search the list

1. Pick a **Type** or **Status**, or type a name into the search box.

### Sort by a column

1. Click the column header - Name, Type, Status, XP Earned, XP Unspent, or Player.
2. Click it again to reverse the order.

### Assign or change a character's player (Storyteller)
...
1. When "... now has an account -" appears under **Player**, click **Confirm**.
...
- [Roles](roles.md)
- [Player Guide](../player-guide.md#1-your-characters)
