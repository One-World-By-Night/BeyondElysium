...
- A table of every rule currently set for the chosen chronicle: **Block**, **Target** (the item, power, level, range, or option it addresses), **Approval**, **Reason**, **Edit**, **Delete**.
