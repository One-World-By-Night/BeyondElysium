...
- **Powered by BeyondElysium** - the line itself; "BeyondElysium" is the clickable part.
- The **Credits** modal it opens:
  - A link to beyondelysium.com.
  - The chronicle-independent credits text.
  - **In Memoriam** - a list of names, each with an optional short note.
  - **Edit** (site administrators only) - switches the modal to editing:
    - The credits text, as a text area (with an **AI Assist** button for an administrator).
    - Each in-memoriam entry as a **Name** and an optional **Note**, with its own **Remove**.
    - **+ Add name** to add another entry.
    - **Save** / **Cancel**.

## Common tasks

### Read the credits and in-memoriam list

1. Find "Powered by BeyondElysium" at the bottom of any front-end page.
2. Click **BeyondElysium**.

### Update the credits text or the in-memoriam list (site administrator)

1. Open the Credits modal.
2. Click **Edit**.
3. Change the credits text, or add, edit, or remove names in **In Memoriam**.
4. Click **Save**.
