...
Any player, for their own characters only.

## How to get there

My Chronicle → After-Game Report tab.

## The screen

- **Session** - a dropdown of recent sessions on or before today.
- **Character** - a dropdown of your own characters.
- Once both are picked, three fields:
...
### File a report after a game

1. Open My Chronicle → After-Game Report.
2. Pick tonight's session and the character who played.
3. Fill in what you can - none of the three fields is required on its own.
4. Click **Submit Report**.

### Change a report you already filed

1. Open My Chronicle → After-Game Report.
2. Pick the same session and character again - your own words load back in.
3. Change what you need, then click **Save Changes**.
