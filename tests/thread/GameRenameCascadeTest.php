...
/**
 * A chronicle rename cascades to every table that stores the slug, against real rows.
 */
class GameRenameCascadeTest extends WP_UnitTestCase {
	...
	public function test_a_rename_into_a_slug_with_an_orphaned_fork_aborts_and_leaves_everything_untouched(): void {
		...
		// An orphaned fork at the destination slug.
	...
	/**
	 * A rename rewrites the House Rules shortcode wherever it was placed.
	 */
