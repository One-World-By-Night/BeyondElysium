...
class DeclaredSchemaRoundTripThreadTest extends WP_UnitTestCase {
	...
	/**
	 * The whole `_meta` block: ranks, ladder, costs, out_of_type, the rank-to-level mapping a genre with non-consecutive
	 * ranks needs, and an untiered track's declaration.
	 */
	...
	/**
	 * An untiered track declares its own cost.
	 */
	...
	/**
	 * The three containers, and the axis a family is filed under.
	 */
