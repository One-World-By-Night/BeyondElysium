...
**`v1.2.6` — released and running in production chronicles.**
...
Download `beyond-elysium-1.2.6.zip` from [Releases](https://github.com/One-World-By-Night/BeyondElysium/releases) and install it through **Plugins → Add New → Upload Plugin**.
